@extends('adminlte::auth.seller-auth-page', ['auth_type' => 'register'])
...
<div>
    <div class="alert alert-danger">
        ...
        ご契約は会社単位でお願い致します。店舗単位で契約されるとAPIによる在庫・価格連動機能や、商品情報や店舗の管理などが利用できません。<br>登録後に管理画面よりユーザーや店舗を増やしてご利用ください。
    </div>
</div>
