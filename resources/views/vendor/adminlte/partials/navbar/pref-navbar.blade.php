<nav class="main-header navbar
    ...
    <form id="search-form" action="/pref" class="form-inline ml-3 flex-form-area" method="GET">
        <div class="input-group input-group-sm flex-form">
          <input class="form-control form-control-navbar" type="search" placeholder="商品名 / サービス名 / JANコードで検索" aria-label="Search" name="keyword" @isset($keyword) value="{{$keyword}}" @endisset>
