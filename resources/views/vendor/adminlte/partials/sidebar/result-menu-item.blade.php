...
@elseif ($menuItemHelper->isSearchBar($item))
    ...
    {{-- Search form --}}
    @include('adminlte::partials.sidebar.result-menu-item-search-form')

@elseif ($menuItemHelper->isSubmenu($item))

    {{-- Treeview menu --}}
    @include('adminlte::partials.sidebar.result-menu-item-treeview-menu')

@elseif ($menuItemHelper->isLink($item))

    {{-- Link --}}
    @include('adminlte::partials.sidebar.result-menu-item-link')
