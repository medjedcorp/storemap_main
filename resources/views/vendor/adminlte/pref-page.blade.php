...
@section('body')
    <div class="wrapper">
        ...
        {{-- Top Navbar --}}
        @include('adminlte::partials.navbar.pref-navbar')

        {{-- Left Main Sidebar --}}
        @include('adminlte::partials.sidebar.pref-left-sidebar')

        {{-- Content Wrapper --}}
        <div class="content-wrapper {{ config('resultadminlte.classes_content_wrapper') ?? '' }}">
