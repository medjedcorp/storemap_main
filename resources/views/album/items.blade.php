...
@section('title', '商品画像一覧 - Storemap Cockpit')

@section('content_header')
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1 class="m-0">{{$c_name}} / @lang('album.item.title')</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="/home">Home</a></li>
        <li class="breadcrumb-item active">@lang('album.item.title')</li>
      </ol>
    </div><!-- /.col -->
  </div><!-- /.row -->
</div>
      ...
      <div class="col-12">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">
              <i class="fas fa-images"></i> @lang('album.item.card_title')
            </h3>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 text-right">
                <button type="button" class="btn btn-success btn-lg" onclick="$('#modalImg').modal('show')" data-toggle="modal" data-target="#exampleModalCenter">
                  <i class="fas fa-cloud-upload-alt"></i>&nbsp;画像を追加する
                </button>
              </div>
            </div>
              ...
              <thead>
                <tr>
                  ...
                  <th class="text-center" style="width:180px;">
                    <form method="POST" action="{{ route('album.item.destroy') }}" class="h-adr" id="img_id">
                      @method('DELETE')
                      @csrf
...
<script type="text/javascript">
  Dropzone.options.imageUpload = {
    dictDefaultMessage: 'アップロードするファイルをここへドロップしてください。<br>縦横の最大幅は750pxです。大きさを超える場合は、自動でリサイズされます。<br>同じファイル名の画像がある場合は上書きされます。<br>アップロードした画像は画像管理の商品画像管理より確認できます。<br>日本語や全角文字を含むファイル名は、自動で半角ファイル名へリネームされます。<br>１度にアップできる枚数は５００枚までです。',
