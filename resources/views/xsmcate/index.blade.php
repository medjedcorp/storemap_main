  ...
  <div id="leftbox" class="col-2">
    <div class="list-group">
      ...
      @foreach($low_cates as $low_cate)
        <form action="/smcate" method="GET" name="form{{$loop->index}}">
          @csrf
          ...
          <button type="submit" class="list-group-item list-group-item-action">{{$low_cate->smcategory_name}}</button>
        </form>
      @endforeach
    </div>
  </div>
  <div class="col-md-5 col-lg-5 col-xl-6 mb-3">
    <div id="target"></div>
  </div>
  <div id="sidebox" class="col-md-5 col-lg-5 col-xl-4 mb-3">
