  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%; border:none; margin:2% auto; max-width: 600px;background-color: #ffffff; padding:0 2%;">
    <tr>
      <td style="padding-top:10px;">
        <h3>{{$name}} 様</h3>
        <p>Storemapをご利用いただき誠にありがとうございます。<br>お客様からのお支払いをキャンセルいたしました。<br>
          キャンセルの詳細は下記をご覧ください。</p>
    ...
    <tr>
      <td style="color:#8e8e8e;font-size:14px;line-height:18px;padding-top:20px;">キャンセル日時</td>
    </tr>
    <tr>
      <td>{{$cancel_time}}</td>
    </tr>
    ...
    @endif
    <tr>
      <td style="padding-top:30px;"><hr></td>
    </tr>
    <tr>
