      ...
      <div class="col-md-12">
        <div class="card card-default">
          ...
          <div class="card-body">
            <blockquote>
              <h5>プライバシーポリシー</h5>
              <p>メジェド合同会社（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
              <dl>
                <dt>第1条（個人情報）</dt>
                ...
                <dd>当社が個人情報を収集・利用する目的は、以下のとおりです。
                  <ol class="first">
                    ...
                    <li>ユーザーにご自身の登録情報の閲覧や変更、削除、ご利用状況の閲覧を行って頂くため</li>
                ...
                <dd>本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。<br>
                  住所：奈良県葛城市竹内２１８番地１４号<br>
                  社名：メジェド合同会社<br>
                  担当部署：StoreMapお問い合わせ窓口<br>
                  Eメールアドレス：smsupport@storemap.jp
                </dd>
              </dl>
