          ...
          <div class="card-body h-adr">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="store_form" type="url" class="form-control is-invalid" name="flyer_url" id="flyer_url" value="{{ old('flyer_url', $store->flyer_url) }}" aria-describedby="flyer_url-error" aria-invalid="true">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="store_form" type="url" class="form-control is-invalid" name="floor_guide" id="floor_guide" value="{{ old('floor_guide', $store->floor_guide) }}" aria-describedby="floor_guide-error" aria-invalid="true">
