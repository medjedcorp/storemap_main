        ...
        <div class="card card-primary">
          ...
          <div class="card-body h-adr">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input form="store_form" type="text" class="form-control" id="company_id" name="company_id" placeholder="company_idを入力" value="{{ old('company_id') }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control" id="store_code" name="store_code" placeholder="@lang('store.register.store_code_pholder')" value="{{old('store_code')}}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              <label for="store_name" class="col-sm-2 col-form-label">@lang('store.register.store_name')
              ...
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control" id="store_name" name="store_name" placeholder="@lang('store.register.store_name_pholder')" value="{{old('store_name')}}">
                @endif
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control" id="store_kana" name="store_kana" placeholder="店舗名をひらがなで入力してください" value="{{old('store_kana')}}">
                @endif
              </div>
            </div>
            @endif
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control p-postal-code" id="store_postcode" name="store_postcode" value="{{old('store_postcode')}}" placeholder="@lang('common.pcode_pholder')">
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control p-region" id="prefecture" name="prefecture" value="{{old('prefecture')}}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              <label for="store_city" class="col-sm-2 col-form-label">@lang('common.city')
                @include('partials.required')</label>
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control p-locality" id="store_city" name="store_city" value="{{old('store_city')}}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              <label for="store_adnum" class="col-sm-2 col-form-label">@lang('common.adnum')
                @include('partials.required')</label>
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control p-street-address" id="store_adnum" name="store_adnum" value="{{old('store_adnum')}}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="text" class="form-control p-extended-address" id="store_apart" name="store_apart" value="{{old('store_apart')}}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              <label for="store_phone_number" class="col-sm-2 col-form-label">@lang('common.phone_number')
                @include('partials.required')</label>
              <div class="col-sm-10">
                ...
                @else
                <input form="store_form" type="tel" class="form-control" id="store_phone_number" name="store_phone_number" value="{{old('store_phone_number')}}" placeholder="@lang('common.phone_pholeder')">
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input form="store_form" type="tel" class="form-control @error('store_fax_number') is-invalid @enderror" id="store_fax_number" name="store_fax_number" value="{{old('store_fax_number')}}" placeholder="@lang('common.fax_pholeder')" @error('store_fax_number') aria-describedby="store_fax_number-error" aria-invalid="true" @enderror>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input form="store_form" type="email" class="form-control @error('store_email') is-invalid @enderror" id="store_email" name="store_email" value="{{old('store_email')}}" @error('store_email') aria-describedby="store_email-error" aria-invalid="true" @enderror>
                @error('store_email')
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                @else
                <textarea form="store_form" class="form-control" id="store_info" name="store_info" value="{{old('store_info')}}">{{old('store_info')}}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <textarea form="store_form" class="form-control is-invalid" name="pay_info" id="pay_info" value="{{old('pay_info')}}" aria-describedby="pay_info-error" aria-invalid="true" placeholder="お店で使える決済方法を入力">{{old('pay_info')}}</textarea>
                <span id="pay_info-error" class="error invalid-feedback">{{$errors->first('pay_info')}}</span>
                @else
                <textarea form="store_form" class="form-control" id="pay_info" name="pay_info" value="{{old('pay_info')}}" placeholder="お店で使える決済方法を入力">{{old('pay_info')}}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <textarea form="store_form" class="form-control is-invalid" name="access" id="access" value="{{old('access')}}" aria-describedby="access-error" aria-invalid="true" placeholder="お店へのアクセスを入力。例：地下鉄〇〇線〇〇駅下車〇番出口から南へ徒歩約〇分">{{old('access')}}</textarea>
                <span id="access-error" class="error invalid-feedback">{{$errors->first('access')}}</span>
                @else
                <textarea form="store_form" class="form-control" id="access" name="access" value="{{old('access')}}" placeholder="お店へのアクセスを入力。例：地下鉄〇〇線〇〇駅下車〇番出口から南へ徒歩約〇分">{{old('access')}}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <textarea form="store_form" class="form-control is-invalid" name="opening_hour" id="opening_hour" value="{{old('opening_hour')}}" aria-describedby="opening_hour-error" aria-invalid="true" placeholder="お店の営業時間を入力">{{old('opening_hour')}}</textarea>
                <span id="opening_hour-error" class="error invalid-feedback">{{$errors->first('opening_hour')}}</span>
                @else
                <textarea form="store_form" class="form-control" id="opening_hour" name="opening_hour" value="{{old('opening_hour')}}" placeholder="お店の営業時間を入力">{{old('opening_hour')}}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <textarea form="store_form" class="form-control is-invalid" name="closed_day" id="closed_day" value="{{old('closed_day')}}" aria-describedby="closed_day-error" aria-invalid="true" placeholder="お店の定休日を入力">{{old('closed_day')}}</textarea>
                <span id="closed_day-error" class="error invalid-feedback">{{$errors->first('closed_day')}}</span>
                @else
                <textarea form="store_form" class="form-control" id="closed_day" name="closed_day" value="{{old('closed_day')}}" placeholder="お店の定休日を入力">{{old('closed_day')}}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <textarea form="store_form" class="form-control is-invalid" name="parking" id="parking" value="{{old('parking')}}" aria-describedby="parking-error" aria-invalid="true" placeholder="お店の駐車場情報を入力">{{old('parking')}}</textarea>
                <span id="parking-error" class="error invalid-feedback">{{$errors->first('parking')}}</span>
                @else
                <textarea form="store_form" class="form-control" id="parking" name="parking" value="{{old('parking')}}" placeholder="お店の駐車場情報を入力">{{old('parking')}}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <div @error('store_img1') class="select2-has-error" @enderror>
                  <select form="store_form" class="form-control select2 img01-ajax is-invalid" id="store_img1" name="store_img1" style="width: 100%;">
                    <option value="{{old('store_img1')}}">{{old('store_img1')}}</option>
                  </select>
              ...
              <div class="col-sm-10">
                <div @error('store_img2') class="select2-has-error" @enderror>
                  <select form="store_form" class="form-control select2 img02-ajax is-invalid" id="store_img2" name="store_img2" style="width: 100%;">
                    <option value="{{old('store_img2')}}">{{old('store_img2')}}</option>
                  </select>
              ...
              <div class="col-sm-10">
                <div @error('store_img3') class="select2-has-error" @enderror>
                  <select form="store_form" class="form-control select2 img03-ajax is-invalid" id="store_img3" name="store_img3" style="width: 100%;">
                    <option value="{{old('store_img3')}}">{{old('store_img3')}}</option>
                  </select>
              ...
              <div class="col-sm-10">
                <div @error('store_img4') class="select2-has-error" @enderror>
                  <select form="store_form" class="form-control select2 img04-ajax is-invalid" id="store_img4" name="store_img4" style="width: 100%;">
                    <option value="{{old('store_img4')}}">{{old('store_img4')}}</option>
                  </select>
              ...
              <div class="col-sm-10">
                <div @error('store_img5') class="select2-has-error" @enderror>
                  <select form="store_form" class="form-control select2 img05-ajax is-invalid" id="store_img5" name="store_img5" style="width: 100%;">
                    <option value="{{old('store_img5')}}">{{old('store_img5')}}</option>
                  </select>
            ...
            <div class="form-group row">
              <label for="industry_id" class="col-sm-2 col-form-label">@lang('store.industry')
                @include('partials.required')</label>
              <div class="col-sm-10">
                <select form="store_form" name="industry_id" class="form-control">
                  @if(isset($store->industry_id) == true)
                  @foreach($industry as $key)
                  @if($store->industry_id == $key->id)
                  <option value="{{$key->id}}" selected="selected">{{$key->industry_name}}</option>
                  @else
          ...
          <div class="card-footer">
            <form id="store_form" method="POST" action="{{route('stores.store')}}" enctype="multipart/form-data" class="inline_form">
              @csrf
              @method('POST')
              <button type="submit" class="btn btn-primary"><i class="fa fa-check-square"></i>
                @lang('store.register.submit')</button>
            </form>
...
<div class="os-padding text-sm">
  <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
    <div class="os-content" style="padding: 16px; height: 100%; width: 100%;">
      <h5>店舗の登録</h5>
      <hr class="mb-2">
      <p>サイト上に表示可能な店舗情報の登録ができます。</p>
      <dl>
        <dt>店舗コード</dt>
        <dd>店舗を識別するためのコードを登録してください。(半角英数のみ)</dd>
        <dt>店舗名</dt>
        <dd>店舗名を入力してください。</dd>
        <dt>店舗名かな</dt>
