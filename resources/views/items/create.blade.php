...
@section('title', '商品情報の登録 - Storemap Cockpit')

@section('content_header')
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-7">
      <h1 class="m-0">@lang('item.register.title')</h1>
    </div><!-- /.col -->
    <div class="col-sm-5">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="/home">Home</a></li>
        <li class="breadcrumb-item"><a href="/items">商品一覧</a></li>
        <li class="breadcrumb-item active">@lang('item.register.title')</li>
      </ol>
    </div><!-- /.col -->
  </div><!-- /.row -->
</div>
        ...
        <div class="card card-primary card-tabs">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
              <li class="pt-2 px-3">
                <h3 class="card-title"><i class="far fa-list-alt"></i> @lang('item.register.card_title')</h3>
              </li>
              <li class="nav-item">
          ...
          @include('partials.success')
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="item_form" type="text" class="form-control is-invalid" name="product_code" id="product_code" placeholder="@lang('item.product_code_pholder')" value="{{ old('product_code') }}" aria-describedby="product_code-error" aria-invalid="true">
                <span id="product_code-error" class="error invalid-feedback">{{$errors->first('product_code')}}</span>
                @else
                <input form="item_form" type="text" class="form-control" id="product_code" name="product_code" placeholder="@lang('item.product_code_pholder')" value="{{ old('product_code') }}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              <label for="product_name" class="col-sm-2 col-form-label">@lang('item.product_name') @include('partials.required')</label>
              <div class="col-sm-10">
                @if($errors->has('product_name'))
                <input form="item_form" type="text" class="form-control is-invalid" name="product_name" id="product_name" placeholder="@lang('item.product_name_pholder')" value="{{ old('product_name') }}" aria-describedby="product_name-error" aria-invalid="true">
                <span id="product_name-error" class="error invalid-feedback">{{$errors->first('product_name')}}</span>
                @else
                <input form="item_form" type="text" class="form-control" id="product_name" name="product_name" placeholder="@lang('item.product_name_pholder')" value="{{ old('product_name') }}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="item_form" type="text" class="form-control is-invalid" name="barcode" id="barcode" placeholder="@lang('item.barcode_pholder')" value="{{ old('barcode') }}" aria-describedby="barcode-error" aria-invalid="true">
                <span id="barcode-error" class="error invalid-feedback">{{$errors->first('barcode')}}</span>
                @else
                <input form="item_form" type="text" class="form-control" id="barcode" name="barcode" placeholder="@lang('item.barcode_pholder')" value="{{ old('barcode') }}">
                @endif
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="item_form" type="text" class="form-control is-invalid" name="brand_name" id="brand_name" placeholder="@lang('item.brand_name_pholder')" value="{{ old('brand_name') }}" aria-describedby="brand_name-error" aria-invalid="true">
                <span id="brand_name-error" class="error invalid-feedback">{{$errors->first('brand_name')}}</span>
                @else
                <input form="item_form" type="text" class="form-control" id="brand_name" name="brand_name" placeholder="@lang('item.brand_name_pholder')" value="{{ old('brand_name') }}">
                @endif
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="item_form" type="text" class="form-control is-invalid" name="color_name" id="color_name" placeholder="@lang('item.color_name_pholder')" value="{{ old('color_name') }}" aria-describedby="color_name-error" aria-invalid="true">
                <span id="color_name-error" class="error invalid-feedback">{{$errors->first('color_name')}}</span>
                @else
                <input form="item_form" type="text" class="form-control" id="color_name" name="color_name" placeholder="@lang('item.color_name_pholder')" value="{{ old('color_name') }}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="item_form" type="text" class="form-control is-invalid" name="size_name" id="size_name" placeholder="@lang('item.size_name_pholder')" value="{{ old('size_name') }}" aria-describedby="size_name-error" aria-invalid="true">
                <span id="size_name-error" class="error invalid-feedback">{{$errors->first('size_name')}}</span>
                @else
                <input form="item_form" type="text" class="form-control" id="size_name" name="size_name" placeholder="@lang('item.size_name_pholder')" value="{{ old('size_name') }}">
                @endif
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="item_form" type="number" class="form-control is-invalid" name="original_price" id="original_price" value="{{ old('original_price') }}" aria-describedby="original_price-error" aria-invalid="true">
                <span id="original_price-error" class="error invalid-feedback">{{$errors->first('original_price')}}</span>
                @else
                <input form="item_form" type="number" class="form-control" id="original_price" placeholder="@lang('item.original_price_pholder')" name="original_price" value="{{ old('original_price') }}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <textarea form="item_form" type="textarea" class="form-control is-invalid" name="description" id="description" placeholder="@lang('item.description_pholder')" aria-describedby="description-error" aria-invalid="true" rows="3">{{ old('description') }}</textarea>
                <span id="description-error" class="error invalid-feedback">{{$errors->first('description')}}</span>
                @else
                <textarea form="item_form" type="textarea" class="form-control" id="description" name="description" placeholder="@lang('item.description_pholder')" rows="3">{{ old('description') }}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                @if($errors->has('size'))
                <textarea form="item_form" type="textarea" class="form-control is-invalid" name="size" id="size" placeholder="@lang('item.size_pholder')" aria-describedby="size-error" aria-invalid="true" rows="3">{{ old('size') }}</textarea>
                <span id="size-error" class="error invalid-feedback">{{$errors->first('size')}}</span>
                @else
                <textarea form="item_form" type="textarea" class="form-control" id="size" name="size" placeholder="@lang('item.size_pholder')" rows="3">{{ old('size') }}</textarea>
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                @if($errors->has('tag'))
                <input form="item_form" type="text" class="form-control is-invalid" name="tag" id="tag" placeholder="@lang('item.tag_pholder')" value="{{ old('tag') }}" aria-describedby="tag-error" aria-invalid="true">
                <span id="tag-error" class="error invalid-feedback">{{$errors->first('tag')}}</span>
                @else
                <input form="item_form" type="text" class="form-control" id="tag" name="tag" placeholder="@lang('item.tag_pholder')" value="{{ old('tag') }}">
                @endif
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <input form="item_form" type="text" class="form-control is-invalid" name="group_code" id="group_code" placeholder="@lang('item.group_code_pholder')" value="{{ old('group_code') }}" aria-describedby="group_code-error" aria-invalid="true">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <select form="item_form" name="storemap_category_id[]" id="sm_search_result" class="form-control">
                      {{-- <option value="{{ old('storemap_category_id[]') }}">{{ old('storemap_category_id[]', isset($smcate) ? $smcate : '選択してください') }}</option> --}}
                      <option value="{{ old('storemap_category_id[]') }}">{{ old('storemap_category_id[]') }}</option>
                    </select>
                  </div>
                </div>
                <small>選択肢から選ぶ</small>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img1') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img01-ajax is-invalid" id="item_img1" name="item_img1" style="width: 100%;">
                        <option value="{{ old('item_img1') }}">{{ old('item_img1') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img2') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img02-ajax is-invalid" id="item_img2" name="item_img2" style="width: 100%;">
                        <option value="{{ old('item_img2') }}">{{ old('item_img2') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img3') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img03-ajax is-invalid" id="item_img3" name="item_img3" style="width: 100%;">
                        <option value="{{ old('item_img3') }}">{{ old('item_img3') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img4') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img04-ajax is-invalid" id="item_img4" name="item_img4" style="width: 100%;">
                        <option value="{{ old('item_img4') }}">{{ old('item_img4') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img5') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img05-ajax is-invalid" id="item_img5" name="item_img5" style="width: 100%;">
                        <option value="{{ old('item_img5') }}">{{ old('item_img5') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img6') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img06-ajax is-invalid" id="item_img6" name="item_img6" style="width: 100%;">
                        <option value="{{ old('item_img6') }}">{{ old('item_img6') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img7') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img07-ajax is-invalid" id="item_img7" name="item_img7" style="width: 100%;">
                        <option value="{{ old('item_img7') }}">{{ old('item_img7') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img8') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img08-ajax is-invalid" id="item_img8" name="item_img8" style="width: 100%;">
                        <option value="{{ old('item_img8') }}">{{ old('item_img8') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img9') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img09-ajax is-invalid" id="item_img9" name="item_img9" style="width: 100%;">
                        <option value="{{ old('item_img9') }}">{{ old('item_img9') }}</option>
                      </select>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div @error('item_img10') class="select2-has-error" @enderror>
                      <select form="item_form" class="form-control select2 img10-ajax is-invalid" id="item_img10" name="item_img10" style="width: 100%;">
                        <option value="{{ old('item_img10') }}">{{ old('item_img10') }}</option>
                      </select>
...
<script src="{{ asset('js/itemimg_select.js') }}"></script>
