...
final class StoreCsvImportService
{
    ...
    public function validationMessages()
    {
        return [
            ...
            'flyer_img.img_name' => '(flyer_img)jpeg,png,jpg,gif形式で指定してください',
            'flyer_img.max' => '(flyer_img)ファイル名は100文字以内で入力してください',
            'floor_guide.img_name' => '(floor_guide)jpeg,png,jpg,gif形式で指定してください',
            'floor_guide.max' => '(floor_guide)ファイル名は100文字以内で入力してください',
