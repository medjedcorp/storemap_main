...
return [
    ...
    */
    'columns'                       => [
        'alpha'   => [
            'rows'  => ['description', 'email', 'name', 'slug','role','category_code', 'category_name', 'display_flag','product_code', 'product_name', 'store_code', 'store_name', 'pause_flag'],
            'class' => 'fa fa-sort-alpha',
        ],
        'amount'  => [
            'rows'  => ['original_price', 'amount', 'price'],
            'class' => 'fa fa-sort-amount',
        ],
        'numeric' => [
            'rows'  => ['created_at', 'updated_at', 'level', 'id', 'phone_number', 'store_phone_number', 'barcode'],
